...
class CastorJetTreeProducer : public edm::EDAnalyzer {
   public:
      explicit CastorJetTreeProducer(const edm::ParameterSet&);
      ~CastorJetTreeProducer();
...
//
CastorJetTreeProducer::CastorJetTreeProducer(const edm::ParameterSet& iConfig)
...
void
CastorJetTreeProducer::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup){
...
void 
CastorJetTreeProducer::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
CastorJetTreeProducer::endJob() 
{
}
...
void
CastorJetTreeProducer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(CastorJetTreeProducer);
